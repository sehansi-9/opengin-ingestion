...
export default function AddPage() {
  ...
  return (
    <div className="container mx-auto py-10 px-4">
      <div className="mb-8">
        <h1 className="text-3xl font-bold mb-2">Network Configurations</h1>
        <p className="text-muted-foreground">Manage your network ingestion configurations</p>
      </div>
          ...
          <Card key={index} className="flex flex-col">
            ...
            <CardContent className="flex-grow space-y-3">
              <div>
                ...
                <p className="text-sm truncate" title={cfg.name}>
                  {cfg.name}
                </p>
              </div>
              <div>
                <h3 className="text-xs font-medium text-muted-foreground mb-1">Update API</h3>
                <p className="text-sm truncate" title={cfg.link}>
                  {cfg.link}
                </p>
              </div>
